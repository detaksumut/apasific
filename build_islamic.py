...
main_content = """
    ...
    <header class="page-hero">
      ...
      <div class="container page-hero-content">
        ...
        <h1 class="page-title" style="font-size: 3rem; margin-bottom: 12px; font-family: var(--font-cinzel);" data-aos="fade-up" data-aos-delay="100">Islamic Studies, Ethics &amp; Spirituality</h1>
        ...
        <p class="page-subtitle" style="font-size: 1.1rem; font-style: italic; max-width: 800px; margin: 0 auto; color: var(--text-muted);" data-aos="fade-up" data-aos-delay="300">Integrating Islamic Values, Ethics, and Spiritual Leadership for Sustainable Development</p>
      </div>
    </header>
          ...
          <div class="journal-main-content" style="display: flex; flex-direction: column; gap: 40px;" data-aos="fade-right">
            ...
            <div style="background: var(--bg-card); border: 1px solid var(--border); border-radius: var(--radius); padding: 35px;">
              ...
              <p style="text-align: justify; line-height: 1.8; color: var(--text); margin-bottom: 0;">
                The Islamic Studies, Ethics &amp; Spirituality discipline under the Association of Asia Pacific Academician (ASIA) provides an academic platform for researchers, academics, scholars, professionals, practitioners, and policymakers to publish scholarly works in the fields of Islamic studies, ethics, and spirituality. This discipline encourages scientific contributions that promote ethical values, spiritual leadership, Islamic knowledge, and sustainable development based on universal moral principles.
              </p>
            </div>
            ...
            <div style="background: var(--bg-card); border: 1px solid var(--border); border-radius: var(--radius); padding: 35px;">
              ...
              <ul class="values-list" style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px 24px; padding-left: 5px;">
                ...
                <li>Sharia Accounting</li>
                <li>Professional Ethics</li>
                <li>Spiritual Leadership</li>
                <li>Transcendental Studies</li>
              </ul>
            </div>
            ...
            <div style="background: var(--bg-card); border: 1px solid var(--border); border-radius: var(--radius); padding: 35px; text-align: center;">
              ...
              <p style="line-height: 1.8; color: var(--text); margin-bottom: 25px;">
                Researchers, academics, scholars, professionals, and practitioners are invited to submit original manuscripts related to the scope of this discipline through the ASIA online submission system.
              </p>
          ...
          <div class="journal-sidebar" style="position: sticky; top: 110px; display: flex; flex-direction: column; gap: 30px;" data-aos="fade-left">
            <div style="background: var(--bg-card); border: 1px solid var(--border); border-radius: var(--radius); overflow: hidden; box-shadow: var(--shadow);">
              ...
              <div style="position: relative; height: 180px; overflow: hidden; border-bottom: 1px solid var(--border);">
                <img src="public/islamic_journal_cover.png" alt="Journal Cover" style="width: 100%; height: 100%; object-fit: cover;" />
              ...
              <div style="padding: 25px; font-family: 'Inter', sans-serif;">
                <h3 style="font-size: 16px; font-weight: bold; color: var(--white); margin-bottom: 10px; line-height: 1.4;">
                  Jurnal Kajian Islam, Etika dan Spiritualitas
                </h3>
                <p style="font-size: 12px; color: var(--text-muted); line-height: 1.6; margin-bottom: 20px;">
                  Fokus pada kajian ekonomi Islam, akuntansi syariah, etika profesi, kepemimpinan spiritual, dan studi transendental.
                </p>
                ...
                <div style="background: rgba(8,8,16,0.4); border: 1px solid var(--border); border-radius: var(--radius-sm); padding: 15px; margin-bottom: 20px;">
                  ...
                  <ul style="padding-left: 12px; margin: 0; color: var(--text); font-size: 12px; line-height: 1.7; list-style-type: circle;">
                    ...
                    <li>Etika Profesi</li>
                    <li>Kepemimpinan Spiritual</li>
                    <li>Studi Transendental</li>
                  </ul>
                </div>
...
html = html.replace("<title>ASIACERT", "<title>Islamic Studies, Ethics &amp; Spirituality")
html = html.replace('content="Asia Professional Certification Center', 'content="Islamic Studies, Ethics &amp; Spirituality discipline under ASIA')
html = re.sub(r"style\.css\?v=\d+", "style.css?v=36", html)

with open("islamic.html", "w", encoding="utf-8") as f:
    f.write(html)
print("islamic.html created.")
...
idx = idx.replace(
    '<a href="#div-islamic"><span class="dd-icon">\u25c8</span> Islamic Studies</a>',
...
if nav_match:
    ...
    files = [
        ...
        "education.html","tourism.html","agriculture.html","health.html","islamic.html"
    ]
    for fn in files:
