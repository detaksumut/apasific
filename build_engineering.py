...
print("Building engineering.html...")
...
engineering_main_content = """
    ...
    <header class="page-hero">
      ...
      <div class="container page-hero-content">
        ...
        <h1 class="page-title" style="font-size: 3rem; margin-bottom: 12px; font-family: var(--font-cinzel);" data-aos="fade-up" data-aos-delay="100">Engineering, Technology &amp; Applied Sciences</h1>
        ...
        <p class="page-subtitle" style="font-size: 1.1rem; font-style: italic; max-width: 800px; margin: 0 auto; color: var(--text-muted);" data-aos="fade-up" data-aos-delay="300">Engineering Innovation for Sustainable Technology and Industrial Advancement</p>
      </div>
    </header>
          ...
          <div class="journal-main-content" style="display: flex; flex-direction: column; gap: 40px;" data-aos="fade-right">
            ...
            <div style="background: var(--bg-card); border: 1px solid var(--border); border-radius: var(--radius); padding: 35px;">
              ...
              <p style="text-align: justify; line-height: 1.8; color: var(--text); margin-bottom: 0;">
                The Engineering, Technology &amp; Applied Sciences discipline under the Association of Asia Pacific Academician (ASIA) provides an academic platform for researchers, academics, engineers, scientists, technology professionals, and practitioners to publish scholarly works in the fields of engineering, technology, and applied sciences. This discipline encourages scientific contributions that support technological innovation, industrial development, engineering solutions, and sustainable advancement across various sectors.
              </p>
            </div>
          ...
          <div class="journal-sidebar" style="position: sticky; top: 110px; display: flex; flex-direction: column; gap: 30px;" data-aos="fade-left">
            ...
            <div style="background: var(--bg-card); border: 1px solid var(--border); border-radius: var(--radius); overflow: hidden; box-shadow: var(--shadow);">
              ...
              <div style="position: relative; height: 180px; overflow: hidden; border-bottom: 1px solid var(--border);">
                <img src="public/engineering_journal_cover.png" alt="Journal Cover" style="width: 100%; height: 100%; object-fit: cover;" />
              ...
              <div style="padding: 25px; font-family: 'Inter', sans-serif;">
                ...
                <p style="font-size: 12px; color: var(--text-muted); line-height: 1.6; margin-bottom: 20px;">
                  Fokus pada kajian ilmu rekayasa, teknologi industri, teknologi terapan, inovasi, dan desain rekayasa.
                </p>
                ...
                <div style="background: rgba(8,8,16,0.4); border: 1px solid var(--border); border-radius: var(--radius-sm); padding: 15px; margin-bottom: 20px;">
                  ...
                  <ul style="padding-left: 12px; margin: 0; color: var(--text); font-size: 12px; line-height: 1.7; list-style-type: circle;">
                    <li>Rekayasa (Engineering)</li>
                    <li>Teknologi Industri</li>
                    <li>Teknologi Terapan</li>
                    <li>Inovasi Teknologi</li>
                    <li>Desain Rekayasa</li>
                  </ul>
                </div>
...
# Assemble engineering.html
engineering_html = header_part + engineering_main_content + footer_part

# Sync navbar and style.css cache globally to v=35
engineering_html = re.sub(r'style\.css\?v=\d+', 'style.css?v=35', engineering_html)

with open('engineering.html', 'w', encoding='utf-8') as f:
    f.write(engineering_html)
print("engineering.html created successfully.")

print("Updating index.html link references...")
with open('index.html', 'r', encoding='utf-8') as f:
    idx_content = f.read()

# Update dropdown menu for engineering
idx_content = idx_content.replace('<a href="index.html#div-engineering"><span class="dd-icon">◈</span> Engineering</a>',
                                  '<a href="engineering.html"><span class="dd-icon">◈</span> Engineering, Technology &amp; Applied Sciences</a>')

# Update homepage card link for engineering
start_idx = idx_content.find('<div class="division-card" id="div-engineering"')
if start_idx != -1:
    link_idx = idx_content.find('href="#contact"', start_idx)
    if link_idx != -1:
        idx_content = idx_content[:link_idx] + 'href="engineering.html" class="div-link">Explore Division →</a>' + idx_content[idx_content.find('</a>', link_idx)+4:]
...
if nav_match:
    ...
    files = [
        ...
        'quality.html', 'academy.html', 'young.html', 'awards.html', 'research.html', 'accounting.html', 'business.html', 'finance.html', 'hr.html', 'economics.html', 'law.html', 'it.html', 'engineering.html'
    ]
    for fn in files:
        if os.path.exists(fn):
            ...
            if start_idx != -1 and end_idx != -1:
                ...
                # Bump cache to v=35
                new_content = re.sub(r'style\.css\?v=\d+', 'style.css?v=35', new_content)
    ...
    idx_content = re.sub(r'style\.css\?v=\d+', 'style.css?v=35', idx_content)
    with open('index.html', 'w', encoding='utf-8') as f:
        f.write(idx_content)
