...
print("Building agriculture.html...")
...
main_content = """
    ...
    <header class="page-hero">
      ...
      <div class="container page-hero-content">
        ...
        <h1 class="page-title" style="font-size: 3rem; margin-bottom: 12px; font-family: var(--font-cinzel);" data-aos="fade-up" data-aos-delay="100">Agriculture, Environment &amp; Sustainability</h1>
        ...
        <p class="page-subtitle" style="font-size: 1.1rem; font-style: italic; max-width: 800px; margin: 0 auto; color: var(--text-muted);" data-aos="fade-up" data-aos-delay="300">Cultivating Sustainable Agriculture for a Better Future</p>
      </div>
    </header>
          ...
          <div class="journal-main-content" style="display: flex; flex-direction: column; gap: 40px;" data-aos="fade-right">
            ...
            <div style="background: var(--bg-card); border: 1px solid var(--border); border-radius: var(--radius); padding: 35px;">
              ...
              <p style="text-align: justify; line-height: 1.8; color: var(--text); margin-bottom: 0;">
                The Agriculture, Environment &amp; Sustainability discipline under the Association of Asia Pacific Academician (ASIA) provides an academic platform for researchers, academics, professionals, practitioners, and policymakers to publish scholarly works in the fields of agriculture, environmental studies, and sustainable development. This discipline encourages scientific contributions that support environmental conservation, climate resilience, sustainable resource management, and the achievement of global sustainable development goals.
              </p>
            </div>
          ...
          <div class="journal-sidebar" style="position: sticky; top: 110px; display: flex; flex-direction: column; gap: 30px;" data-aos="fade-left">
            <div style="background: var(--bg-card); border: 1px solid var(--border); border-radius: var(--radius); overflow: hidden; box-shadow: var(--shadow);">
              ...
              <div style="position: relative; height: 180px; overflow: hidden; border-bottom: 1px solid var(--border);">
                <img src="public/agriculture_journal_cover.png" alt="Journal Cover" style="width: 100%; height: 100%; object-fit: cover;" />
              ...
              <div style="padding: 25px; font-family: 'Inter', sans-serif;">
                <h3 style="font-size: 16px; font-weight: bold; color: var(--white); margin-bottom: 10px; line-height: 1.4;">
                  Jurnal Pertanian, Lingkungan dan Keberlanjutan
                </h3>
                <p style="font-size: 12px; color: var(--text-muted); line-height: 1.6; margin-bottom: 20px;">
                  Fokus pada kajian pertanian, lingkungan hidup, perubahan iklim, ekonomi hijau, ekonomi sirkular, dan pencapaian SDGs.
                </p>
...
html = html.replace("<title>ASIACERT", "<title>Agriculture, Environment &amp; Sustainability")
html = html.replace('content="Asia Professional Certification Center', 'content="Agriculture, Environment &amp; Sustainability discipline under ASIA')
html = re.sub(r"style\.css\?v=\d+", "style.css?v=36", html)

with open("agriculture.html", "w", encoding="utf-8") as f:
    f.write(html)
print("agriculture.html created.")

# Fix index.html link - direct replacement on the exact line
with open("index.html", "r", encoding="utf-8") as f:
    idx = f.read()

idx = idx.replace(
    '<a href="#div-agriculture"><span class="dd-icon">\u25c8</span> Agriculture</a>',
...
if nav_match:
    ...
    files = [
        ...
        "education.html","tourism.html","agriculture.html"
    ]
    for fn in files:
