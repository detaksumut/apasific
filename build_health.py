...
main_content = """
    ...
    <header class="page-hero">
      ...
      <div class="container page-hero-content">
        ...
        <h1 class="page-title" style="font-size: 3rem; margin-bottom: 12px; font-family: var(--font-cinzel);" data-aos="fade-up" data-aos-delay="100">Health, Public Health &amp; Well-Being</h1>
        ...
        <p class="page-subtitle" style="font-size: 1.1rem; font-style: italic; max-width: 800px; margin: 0 auto; color: var(--text-muted);" data-aos="fade-up" data-aos-delay="300">Advancing Health, Well-Being, and Quality of Life</p>
      </div>
    </header>
          ...
          <div class="journal-main-content" style="display: flex; flex-direction: column; gap: 40px;" data-aos="fade-right">
            ...
            <div style="background: var(--bg-card); border: 1px solid var(--border); border-radius: var(--radius); padding: 35px;">
              ...
              <p style="text-align: justify; line-height: 1.8; color: var(--text); margin-bottom: 0;">
                The Health, Public Health &amp; Well-Being discipline under the Association of Asia Pacific Academician (ASIA) provides an academic platform for researchers, academics, healthcare professionals, practitioners, and policymakers to publish scholarly works in the fields of health and public health. This discipline encourages scientific contributions that support health promotion, disease prevention, healthcare management, occupational safety, and the improvement of individual and community well-being.
              </p>
            </div>
            ...
            <div style="background: var(--bg-card); border: 1px solid var(--border); border-radius: var(--radius); padding: 35px; text-align: center;">
              ...
              <p style="line-height: 1.8; color: var(--text); margin-bottom: 25px;">
                Researchers, academics, healthcare professionals, and practitioners are invited to submit original manuscripts related to the scope of this discipline through the ASIA online submission system.
              </p>
          ...
          <div class="journal-sidebar" style="position: sticky; top: 110px; display: flex; flex-direction: column; gap: 30px;" data-aos="fade-left">
            <div style="background: var(--bg-card); border: 1px solid var(--border); border-radius: var(--radius); overflow: hidden; box-shadow: var(--shadow);">
              ...
              <div style="position: relative; height: 180px; overflow: hidden; border-bottom: 1px solid var(--border);">
                <img src="public/health_journal_cover.png" alt="Journal Cover" style="width: 100%; height: 100%; object-fit: cover;" />
              ...
              <div style="padding: 25px; font-family: 'Inter', sans-serif;">
                <h3 style="font-size: 16px; font-weight: bold; color: var(--white); margin-bottom: 10px; line-height: 1.4;">
                  Jurnal Kesehatan, Kesehatan Masyarakat dan Kesejahteraan
                </h3>
                <p style="font-size: 12px; color: var(--text-muted); line-height: 1.6; margin-bottom: 20px;">
                  Fokus pada kajian kesehatan masyarakat, manajemen kesehatan, keselamatan dan kesehatan kerja, serta kesejahteraan individu dan komunitas.
                </p>
...
html = html.replace("<title>ASIACERT", "<title>Health, Public Health &amp; Well-Being")
html = html.replace('content="Asia Professional Certification Center', 'content="Health, Public Health &amp; Well-Being discipline under ASIA')
html = re.sub(r"style\.css\?v=\d+", "style.css?v=36", html)

with open("health.html", "w", encoding="utf-8") as f:
    f.write(html)
print("health.html created.")
...
idx = idx.replace(
    '<a href="#div-health"><span class="dd-icon">\u25c8</span> Health</a>',
...
if nav_match:
    ...
    files = [
        ...
        "education.html","tourism.html","agriculture.html","health.html"
    ]
    for fn in files:
