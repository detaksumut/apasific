...
export default function CertificationsAdmin() {
  ...
  return (
    <div className="p-8 min-h-screen bg-[#05050a] text-gray-200 relative animate-in fade-in slide-in-from-bottom-4 duration-700">
      {/* TOAST NOTIFICATION */}
      {toastMessage && (
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8 border-b border-gray-800 pb-4">
          <div>
            <h2 className="text-[#c9a84c] text-3xl font-bold font-serif mb-2">Manajemen Sertifikasi</h2>
