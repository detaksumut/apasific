...
const ORG_STRUCTURE: OrgMember[] = [
  ...
  { no: 22, level: "Strategic Bodies", position: "Chairman – Conference & Academic Forum",          name: "Cliff Cheng",                             division: "Conference & Academic Forum" },
  { no: 23, level: "Strategic Bodies", position: "Secretary – Conference & Academic Forum",         name: "Dr. Ha Thuy",                             division: "Conference & Academic Forum" },
  { no: 24, level: "Strategic Bodies", position: "Chairman – Publication & Knowledge Center",       name: "Dr. Hakan Aslan",                         division: "Publication & Knowledge Center" },
  { no: 25, level: "Strategic Bodies", position: "Secretary – Publication & Knowledge Center",      name: "Dr. Wahida",                              division: "Publication & Knowledge Center" },
  { no: 26, level: "Strategic Bodies", position: "Chairman – Academic Mobility Center",             name: "Dr. Muhammad Hashim",                     division: "Academic Mobility Center" },
  { no: 27, level: "Strategic Bodies", position: "Secretary – Academic Mobility Center",            name: "Dr. Raja Haslinda",                       division: "Academic Mobility Center" },
  { no: 28, level: "Strategic Bodies", position: "Chairman – Competition Center",                   name: "Dr. Nifaosan",                            division: "Competition Center" },
  { no: 29, level: "Strategic Bodies", position: "Secretary – Competition Center",                  name: "Dr. Ryan",                                division: "Competition Center" },
  { no: 30, level: "Strategic Bodies", position: "Chairman – Community Engagement & SDGs Center",   name: "Prof. Dr. Indra Devi",                    division: "Community Engagement & SDGs Center" },
  { no: 31, level: "Strategic Bodies", position: "Secretary – Community Engagement & SDGs Center",  name: "Dr. Intan Fatimah Anwar",                 division: "Community Engagement & SDGs Center" },
  { no: 32, level: "Strategic Bodies", position: "Chairman – Quality Assurance & Accreditation Board", name: "Dr. Majo George",                     division: "Quality Assurance & Accreditation Board" },
  { no: 33, level: "Strategic Bodies", position: "Secretary – Quality Assurance & Accreditation Board", name: "DR. Mohammad Sahabuddin",             division: "Quality Assurance & Accreditation Board" },
  { no: 34, level: "Strategic Bodies", position: "Chairman – Digital Academy & AI Center",          name: "DR. Eko Cahyo Mayndarto, SE, M.Si, Ak",   division: "Digital Academy & AI Center" },
  { no: 35, level: "Strategic Bodies", position: "Secretary – Digital Academy & AI Center",         name: "Dr. Anwar Masatip, MMPAR",                division: "Digital Academy & AI Center" },
  { no: 36, level: "Strategic Bodies", position: "Chairman – Young Academician Network",            name: "Dr. Enos Julvirta, MMPAR",                division: "Young Academician Network" },
