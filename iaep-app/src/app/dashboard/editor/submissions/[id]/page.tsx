    ...
    <div className="max-w-6xl mx-auto space-y-6 pb-20 relative">
      ...
      {decisionModalOpen && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200 border border-gray-100">
            {/* Header */}
            <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-gradient-to-r from-[#0d0d1a] to-[#1a1a2e]">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-[#c9a84c]/20 rounded-lg">
                  <svg className="w-6 h-6 text-[#c9a84c]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                </div>
                <h2 className="text-xl font-bold text-white tracking-wide">Record Editorial Decision</h2>
              </div>
              <button onClick={() => setDecisionModalOpen(false)} className="text-gray-400 hover:text-white transition-colors bg-white/5 hover:bg-white/10 p-2 rounded-full">
            ...
            <div className="p-8 overflow-y-auto flex-1 space-y-8 bg-gray-50/50">
              ...
              <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm">
                <label className="block text-sm font-bold mb-3 text-gray-800">Decision <span className="text-red-500">*</span></label>
                <div className="relative">
                  <select 
                    value={decision}
                    onChange={handleDecisionChange}
                    className="w-full appearance-none border border-gray-300 rounded-lg py-3 px-4 text-gray-900 bg-gray-50 focus:bg-white focus:border-[#c9a84c] focus:outline-none focus:ring-4 focus:ring-[#c9a84c]/10 transition-all font-medium cursor-pointer"
                  >
              ...
              <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm space-y-4">
                <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-wider text-blue-700 bg-blue-100 px-2.5 py-1 rounded-full">Required by Policy</span>
                </div>
                <p className="text-xs text-gray-500 bg-gray-50 p-2 rounded border border-gray-100 flex items-center gap-2">
                  ...
                  Reviewer comments will be automatically attached below this email.
                </p>
                <textarea 
                  rows={6}
                  value={emailText}
                  ...
                  className="w-full border border-gray-300 rounded-lg p-4 text-sm text-gray-800 bg-gray-50 focus:bg-white focus:border-[#c9a84c] font-mono focus:outline-none focus:ring-4 focus:ring-[#c9a84c]/10 transition-all resize-none leading-relaxed"
                ></textarea>
                ...
                <div className="pt-2">
                  <label className="flex items-center gap-2 text-sm font-bold mb-2 text-gray-800">
                    ...
                    Author's Phone / WhatsApp <span className="text-gray-400 font-normal">(Include Country Code)</span>
                  </label>
                  <input 
                    type="tel"
                    value={authorPhone}
                    ...
                    className="w-full border border-gray-300 rounded-lg py-3 px-4 text-gray-900 bg-gray-50 focus:bg-white focus:border-[#c9a84c] focus:outline-none focus:ring-4 focus:ring-[#c9a84c]/10 transition-all font-medium tracking-wide"
                  />
                </div>
              </div>
            </div>
            ...
            {/* Footer */}
            <div className="p-6 border-t border-gray-100 flex flex-wrap-reverse justify-end gap-3 bg-white">
              <button onClick={() => setDecisionModalOpen(false)} className="px-6 py-2.5 border border-gray-300 text-gray-700 rounded-lg font-bold hover:bg-gray-50 hover:text-gray-900 transition-all flex-1 sm:flex-none">
                Cancel
              </button>
              <button disabled={!decision} onClick={() => handleRecordDecision(false)} className="px-6 py-2.5 bg-[#18182e] hover:bg-[#252542] text-white rounded-lg font-bold disabled:opacity-50 disabled:cursor-not-allowed shadow-md hover:shadow-lg transition-all flex-1 sm:flex-none flex items-center justify-center gap-2">
              ...
              <a 
                ...
                className={`px-6 py-2.5 bg-[#25D366] hover:bg-[#22c35e] text-white font-bold rounded-lg flex items-center justify-center gap-2 shadow-md hover:shadow-lg transition-all flex-1 sm:flex-none ${!decision ? 'opacity-50 pointer-events-none' : ''}`}
                style={{ textDecoration: 'none' }}
              >
