        ...
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200 border border-slate-200">
            ...
            <div className="px-6 py-4 border-b border-slate-200 flex justify-between items-center bg-white">
              <h2 className="text-lg font-semibold text-slate-900">Record Editorial Decision</h2>
              <button onClick={() => setDecisionModalOpen(false)} className="text-slate-400 hover:text-slate-600 transition-colors p-1 rounded-md hover:bg-slate-100">
            ...
            <div className="p-6 overflow-y-auto flex-1 space-y-6 bg-white">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <select 
                    ...
                    className="w-full appearance-none border border-slate-300 rounded-md py-2 pl-3 pr-10 text-sm text-slate-900 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-shadow cursor-pointer shadow-sm"
                  >
              ...
              <div className="border-t border-slate-200 pt-6 space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <label className="text-sm font-medium text-slate-700">Email Notification to Author</label>
                    <span className="inline-flex items-center rounded-md bg-blue-50 px-2 py-1 text-xs font-medium text-blue-700 ring-1 ring-inset ring-blue-700/10">Required</span>
                  </div>
                  <p className="text-xs text-slate-500">Reviewer comments will be automatically appended to this email.</p>
                  <textarea 
                    rows={6}
                    value={emailText}
                    onChange={e => setEmailText(e.target.value)}
                    data-gramm="false" data-gramm_editor="false" data-enable-grammarly="false" spellCheck={false}
                    className="w-full border border-slate-300 rounded-md p-3 text-sm text-slate-900 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-shadow resize-y shadow-sm font-mono"
                  ></textarea>
                </div>

                {/* Phone Section */}
                <div className="space-y-2 pt-2">
                  <label className="block text-sm font-medium text-slate-700">Author's Phone / WhatsApp</label>
                  <div className="relative rounded-md shadow-sm">
                    ...
                    <input 
                      ...
                      className="block w-full rounded-md border-0 py-2 pl-10 text-slate-900 ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:text-sm sm:leading-6"
                    />
                  </div>
                  <p className="text-xs text-slate-500">Include country code for WhatsApp integration.</p>
                </div>
              </div>
            </div>

            {/* Enterprise Footer */}
            <div className="px-6 py-4 border-t border-slate-200 flex flex-row-reverse gap-3 bg-slate-50">
              <button disabled={!decision} onClick={() => handleRecordDecision(false)} className="inline-flex justify-center rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors">
                Record Decision
              </button>
              <a 
                ...
                className={`inline-flex justify-center items-center gap-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 hover:bg-slate-50 transition-colors ${!decision ? 'opacity-50 pointer-events-none' : ''}`}
                style={{ textDecoration: 'none' }}
              >
              ...
              <button onClick={() => setDecisionModalOpen(false)} className="inline-flex justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 hover:bg-slate-50 mr-auto transition-colors">
                Cancel
              </button>
            </div>
          </div>
