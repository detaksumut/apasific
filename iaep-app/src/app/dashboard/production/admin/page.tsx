...
export default async function AdminEditorDashboard() {
  ...
  try {
    ...
    }).filter(article => article.stage === "Production" && article.status === "Pending Supervisor");
      ...
      <div className="bg-zinc-900/50 border border-zinc-800/80 rounded-xl overflow-hidden">
        ...
        {articles.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <h3 className="text-white font-medium mb-1">Belum ada naskah untuk diperiksa</h3>
            <p className="text-zinc-500 text-sm">Semua naskah telah diterbitkan secara sah.</p>
          </div>
        ) : (
