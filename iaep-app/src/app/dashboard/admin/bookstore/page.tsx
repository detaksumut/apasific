        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fade-in">
          <div className="bg-[#12121f] rounded-xl border border-[#2a2a3e] w-full max-w-2xl shadow-2xl overflow-hidden animate-scale-up">
            ...
            <form onSubmit={handleAddSubmit} className="p-6 space-y-5">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-400 mb-1.5">URL Gambar Kover Buku</label>
                <input type="url" required className="w-full bg-[#0a0a10] border border-[#2a2a3e] rounded-lg px-4 py-2.5 text-white focus:border-[#c9a84c] focus:outline-none transition-colors" placeholder="https://..." />
              </div>
              <div>
