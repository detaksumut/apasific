    ...
    <div class="hero-stats">
      <div class="stats-container">
        <div class="stat-item">
          ...
          <div><span class="stat-num" data-target="5000">0</span><span class="stat-plus">+</span><p class="stat-label">Anggota</p></div>
        </div>
        ...
        <div class="stat-item">
          ...
          <div><span class="stat-num" data-target="25">0</span><span class="stat-plus">+</span><p class="stat-label">Negara</p></div>
        </div>
        <div class="stat-divider"></div>
        <div class="stat-item">
          ...
          <div><span class="stat-num" data-target="100">0</span><span class="stat-plus">+</span><p class="stat-label">Disiplin Akademik</p></div>
        </div>
        <div class="stat-divider"></div>
        <div class="stat-item">
          ...
          <div><span class="stat-num" data-target="300">0</span><span class="stat-plus">+</span><p class="stat-label">Publikasi</p></div>
        </div>
        <div class="stat-divider"></div>
        <div class="stat-item">
          ...
          <div><span class="stat-num" data-target="20">0</span><span class="stat-plus">+</span><p class="stat-label">Acara Tahunan</p></div>
        </div>
      </div>
    </div>
  </section>
    ...
    <section class="section index-section" id="journal-indexing">
      ...
      <div class="journal-launch-wrap" data-aos="fade-up">
        <div class="journal-launch-header">
          ...
          <h3>Jurnal Resmi &mdash; Angkatan 2026</h3>
        </div>
          ...
          <table class="journal-launch-table">
            <thead>
              <tr>
                ...
                <th class="text-center">Status ISSN</th>
                <th class="text-center">Indeksasi</th>
              </tr>
            </thead>
            <tbody>
              <tr>
        ...
        <p class="journal-launch-note">
          ...
          Halaman ini mencerminkan status sebenarnya dari jurnal ASIA pada tahun 2026. Indeksasi adalah proses multi-tahun dan halaman ini akan diperbarui seiring pencapaian target.
        </p>
      </div>
