export default function Home() {
  ...
  <section class="hero" id="home">
    ...
    <div style="position: absolute; top: 15px; left: max(24px, calc((100vw - 1240px) / 2 + 24px)); z-index: 10; background: rgba(10, 10, 15, 0.85); border: 1px solid rgba(201, 168, 76, 0.4); border-radius: 8px; padding: 12px 16px; backdrop-filter: blur(12px); color: #fff; min-width: 260px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.5);">
      <div style="display: flex; align-items: center; gap: 6px; color: #c9a84c; font-weight: 700; font-size: 0.75rem; margin-bottom: 8px; border-bottom: 1px solid rgba(201, 168, 76, 0.2); padding-bottom: 6px; text-transform: uppercase; letter-spacing: 1px;">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#c9a84c" stroke-width="2"><rect x="2" y="5" width="20" height="14" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/></svg>
        Official Bank Account
      </div>
      <div>
        <p style="color: #fff; font-size: 0.75rem; font-weight: bold; margin: 0 0 4px 0;">Association of Asia Pacific Academician</p>
        <p style="margin: 2px 0; font-size: 0.7rem; color: #d1d5db; line-height: 1.4;">Bank: Bank Negara Indonesia (BNI)</p>
        <p style="margin: 2px 0; font-size: 0.7rem; color: #d1d5db; line-height: 1.4;">A/C No: <span style="color: #c9a84c; font-family: monospace; font-size: 0.85rem; font-weight: bold; letter-spacing: 1px;">7006002218</span></p>
        <p style="margin: 2px 0; font-size: 0.7rem; color: #d1d5db; line-height: 1.4;">Swift Code: BNINIDJA</p>
      </div>
    </div>
