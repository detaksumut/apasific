export default function Home() {
  ...
  <section class="hero" id="home">
    ...
    <div style="position: absolute; top: 30px; left: max(24px, calc((100vw - 1240px) / 2 + 24px)); z-index: 10; background: rgba(10, 10, 15, 0.85); border: 1px solid rgba(201, 168, 76, 0.4); border-radius: 8px; padding: 12px 16px; backdrop-filter: blur(12px); color: #fff; min-width: 260px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.5);">
