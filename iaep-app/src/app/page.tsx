...
export default async function Home() {
  ...
  <section class="section promo-section" style="padding: 40px 0 20px 0; background: var(--bg-color); position: relative; z-index: 10; margin-top: 20px;">
    <div class="container" style="max-width: 900px; margin: 0 auto; text-align: center;">
      <video width="100%" controls preload="none" playsinline poster="/banner-apasific.png" style="border-radius: 16px; box-shadow: 0 15px 40px rgba(0,0,0,0.6); border: 1px solid rgba(201,168,76,0.4); display: block;">
