      ...
      <div className="max-w-4xl mx-auto">
        ...
        {sessionData.status === 'READY' && sessionData.exam_data && (
          <div className="bg-[#0d0d1a] border border-gray-800 p-6 rounded-xl shadow-xl">
            <div className="bg-red-900/20 text-red-400 p-4 rounded-lg mb-8 border border-red-900/50 flex items-start gap-4">
            ...
            <div className="mb-8">
              <h3 className="font-bold text-lg text-white mb-4 border-b border-gray-800 pb-2">Soal 1: Multiple Choice</h3>
              <p className="text-gray-300 text-lg mb-4">{sessionData.exam_data.mcq1.q}</p>
              
              <div className="space-y-3">
                {['a', 'b', 'c', 'd'].map(opt => (
                  <label key={opt} className={`flex items-center p-4 rounded-lg border cursor-pointer transition-colors ${
                    ...
                    />
                    <span className="ml-3 font-semibold text-[#c9a84c] uppercase w-6">{opt}.</span>
            ...
            <div className="mb-8">
              <h3 className="font-bold text-lg text-white mb-4 border-b border-gray-800 pb-2">Soal 2: Essay / Kasus</h3>
              <p className="text-gray-300 text-lg mb-4 italic leading-relaxed">{sessionData.exam_data.essay1}</p>
              ...
              <textarea 
                ...
                className="w-full bg-[#05050a] border border-gray-700 p-4 rounded-lg text-white leading-relaxed focus:outline-none focus:border-[#c9a84c] focus:ring-1 focus:ring-[#c9a84c]"
              ></textarea>
            </div>
            ...
            <button 
              ...
              className="w-full bg-gradient-to-r from-[#c9a84c] to-[#e8c97a] hover:from-[#e8c97a] hover:to-[#c9a84c] text-black font-bold uppercase tracking-wider py-4 rounded-xl shadow-[0_0_20px_rgba(201,168,76,0.3)] transition-all transform hover:-translate-y-0.5 disabled:opacity-50"
            >
        ...
        {(sessionData.status === 'SUBMITTED' || sessionData.status === 'COMPLETED') && (
          <div className="bg-[#0d0d1a] border border-gray-800 p-12 rounded-xl text-center shadow-xl">
            <svg className="w-20 h-20 text-[#c9a84c] mx-auto mb-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
            </svg>
            <h2 className="text-2xl font-bold font-serif text-white mb-2">Ujian Selesai!</h2>
