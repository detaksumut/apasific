      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10" style={{ marginLeft: 'auto', marginRight: 'auto', maxWidth: '1280px', display: 'block' }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="mt-8">
            ...
            <section className="w-full bg-[#070714] border border-blue-950/40 rounded-3xl p-5 shadow-2xl relative overflow-hidden text-xs font-sans">
              {/* Background watermarks */}
              <div className="absolute inset-0 opacity-5 pointer-events-none flex justify-center items-center">
                <img src="/logobaru.png" className="w-[200px] object-contain" alt="watermark" />
              </div>

              <h2 className="text-sm sm:text-base font-extrabold text-[#c9a84c] tracking-widest uppercase mb-4 border-b border-blue-950/60 pb-2 flex items-center gap-2 relative z-10">
              ...
              <div className="space-y-3.5 relative z-10">
                ...
                <div className="bg-[#0b0c16]/80 border border-blue-950/30 rounded-2xl p-3.5 space-y-2">
                  <span className="block text-[10px] font-bold text-gray-400 uppercase tracking-widest">Publication Lifecycle</span>
                ...
                {/* Box 2: Membership Evidence & Certification */}
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="bg-[#0b0c16]/80 border border-blue-950/30 rounded-2xl p-3 space-y-1.5">
                    <span className="block text-[10px] font-bold text-green-400 uppercase tracking-widest">Membership</span>
                    <div className="space-y-0.5 text-[11px]">
                      <div><span className="text-gray-500">Status:</span> <span className="font-bold text-green-400">ACTIVE</span></div>
                      <div><span className="text-gray-500">ID:</span> <span className="font-semibold text-white font-mono text-[10px]">APS-2026-00125</span></div>
                      <div><span className="text-gray-500">Exp:</span> <span className="font-semibold text-green-400">2027 (Verified)</span></div>
                    </div>
                  </div>

                  <div className="bg-[#0b0c16]/80 border border-blue-950/30 rounded-2xl p-3 space-y-1.5">
                    <span className="block text-[10px] font-bold text-purple-400 uppercase tracking-widest">Certification</span>
                    <div className="space-y-0.5 text-[11px]">
                      <div><span className="text-gray-500">Status:</span> <span className="font-bold text-purple-400">Certified</span></div>
                      <div><span className="text-gray-500">Track:</span> <span className="font-semibold text-white text-[10px]">Methodology</span></div>
                      <div><span className="text-gray-500">Cert:</span> <span className="font-semibold text-white font-mono text-[10px]">CERT-2026-0042</span></div>
                    </div>
                  </div>
                </div>

                {/* Box 3: Journal Specifications */}
                <div className="bg-[#0b0c16]/80 border border-blue-950/30 rounded-2xl p-3.5 space-y-1.5">
                  <span className="block text-[10px] font-bold text-yellow-500 uppercase tracking-widest">Journal Specifications</span>
                  <div className="grid grid-cols-2 gap-2 text-[11px]">
                    <div><span className="text-gray-500">Model:</span> <span className="font-semibold text-white block">Diamond OA</span></div>
                    <div><span className="text-gray-500">APC:</span> <span className="font-semibold text-green-400 block">Free (Funded)</span></div>
                    <div><span className="text-gray-500">Peer Review:</span> <span className="font-semibold text-white block">Double Blind</span></div>
                    <div><span className="text-gray-500">Language:</span> <span className="font-semibold text-white block">English</span></div>
                  </div>
                </div>

                {/* Box 4: Editorial & AI Logs */}
                <div className="bg-[#0b0c16]/80 border border-blue-950/30 rounded-2xl p-3.5 space-y-1.5">
                  <span className="block text-[10px] font-bold text-blue-400 uppercase tracking-widest">Editorial & AI Logs</span>
                  <div className="grid grid-cols-2 gap-2 text-[11px]">
                    <div><span className="text-gray-500">Reviewers:</span> <span className="font-semibold text-white block">2 Reviewers</span></div>
                    <div><span className="text-gray-500">Duration:</span> <span className="font-semibold text-white block">14 days</span></div>
                    <div><span className="text-gray-500">AI Screen:</span> <span className="font-bold text-green-400 block">PASS (Safe)</span></div>
                    <div><span className="text-gray-500">Similarity:</span> <span className="font-semibold text-white block">14% Match</span></div>
                  </div>
                </div>

                {/* Box 5: Technical Runtime Diagnostics */}
                <div className="bg-[#0b0c16]/80 border border-blue-950/30 rounded-2xl p-3 space-y-1 text-[10px]">
                  <span className="block text-[10px] font-bold text-cyan-400 uppercase tracking-widest mb-1">Technical Runtime Diagnostics</span>
                  <div className="grid grid-cols-2 gap-x-2 gap-y-0.5">
                    <div><span className="text-gray-500">ROBOTS.TXT:</span> <span className="font-bold text-green-400">PASS</span></div>
                    ...
                    <div><span className="text-gray-500">SCHEMA:</span> <span className="font-semibold text-green-400">JATS VALID</span></div>
                  </div>
                </div>
