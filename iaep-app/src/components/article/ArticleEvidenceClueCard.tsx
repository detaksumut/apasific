      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-gray-800 pb-4">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-400">Ekstraksi 5 pilar struktur riset dan sintesis verifikasi substantif</p>
          </div>
        </div>
        ...
        <div className="text-[11px] font-mono text-zinc-400 bg-[#16162a] border border-gray-800 px-3 py-1.5 rounded-lg flex items-center gap-1.5 self-start sm:self-auto">
          ...
          <span>STATUS: TERVERIFIKASI TELAHAAN SEJAWAT</span>
        </div>
      </div>
