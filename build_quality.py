...
quality_main_content = """
    ...
    <header class="page-hero">
      ...
      <div class="container page-hero-content">
        <img src="asia-quality.png" alt="ASIA-QAAB Logo" class="page-hero-logo" style="width: 200px; height: 200px; margin-bottom: 30px; animation: pulse-glow 4s infinite;" data-aos="zoom-in" />
