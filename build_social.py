...
social_main_content = """
    ...
    <header class="page-hero">
      ...
      <div class="container page-hero-content">
        ...
        <h1 class="page-title" style="font-size: 3rem; margin-bottom: 12px; font-family: var(--font-cinzel);" data-aos="fade-up" data-aos-delay="100">Social Sciences, Humanities &amp; Communication</h1>
        ...
        <p class="page-subtitle" style="font-size: 1.1rem; font-style: italic; max-width: 800px; margin: 0 auto; color: var(--text-muted);" data-aos="fade-up" data-aos-delay="300">Advancing Human Understanding, Culture, and Global Communication</p>
      </div>
    </header>
          ...
          <div class="journal-main-content" style="display: flex; flex-direction: column; gap: 40px;" data-aos="fade-right">
            ...
            <div style="background: var(--bg-card); border: 1px solid var(--border); border-radius: var(--radius); padding: 35px;">
              ...
              <p style="text-align: justify; line-height: 1.8; color: var(--text); margin-bottom: 0;">
                The Social Sciences, Humanities &amp; Communication discipline under the Association of Asia Pacific Academician (ASIA) provides an academic platform for researchers, academics, professionals, and practitioners to publish scholarly works in the fields of social sciences, humanities, and communication. This discipline encourages scientific contributions that promote social development, cultural understanding, human values, and effective communication in addressing contemporary global challenges.
              </p>
            </div>
            ...
            <div style="background: var(--bg-card); border: 1px solid var(--border); border-radius: var(--radius); padding: 35px;">
              ...
              <ul class="values-list" style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px 24px; padding-left: 5px;">
                ...
                <li>Language</li>
                <li>Philosophy</li>
                <li style="grid-column: span 2;">Humanities</li>
              </ul>
            </div>
          ...
          <div class="journal-sidebar" style="position: sticky; top: 110px; display: flex; flex-direction: column; gap: 30px;" data-aos="fade-left">
            ...
            <div style="background: var(--bg-card); border: 1px solid var(--border); border-radius: var(--radius); overflow: hidden; box-shadow: var(--shadow);">
              ...
              <div style="position: relative; height: 180px; overflow: hidden; border-bottom: 1px solid var(--border);">
                <img src="public/social_journal_cover.png" alt="Journal Cover" style="width: 100%; height: 100%; object-fit: cover;" />
              ...
              <div style="padding: 25px; font-family: 'Inter', sans-serif;">
                <h3 style="font-size: 16px; font-weight: bold; color: var(--white); margin-bottom: 10px; line-height: 1.4;">
                  Jurnal Ilmu Sosial, Humaniora dan Komunikasi
                </h3>
                <p style="font-size: 12px; color: var(--text-muted); line-height: 1.6; margin-bottom: 20px;">
                  Fokus pada kajian ilmu sosiologi, psikologi, komunikasi, studi budaya, bahasa, filsafat, dan humaniora.
                </p>
                ...
                <div style="background: rgba(8,8,16,0.4); border: 1px solid var(--border); border-radius: var(--radius-sm); padding: 15px; margin-bottom: 20px;">
                  ...
                  <ul style="padding-left: 12px; margin: 0; color: var(--text); font-size: 12px; line-height: 1.7; list-style-type: circle;">
                    <li>Sosiologi &amp; Psikologi</li>
                    <li>Ilmu Komunikasi</li>
                    <li>Studi Budaya (Culture)</li>
                    <li>Bahasa &amp; Sastra</li>
                    <li>Filsafat (Philosophy)</li>
                    <li>Humaniora</li>
                  </ul>
                </div>
...
# Assemble social.html
social_html = header_part + social_main_content + footer_part

# Sync navbar and style.css cache globally to v=36
social_html = re.sub(r'style\.css\?v=\d+', 'style.css?v=36', social_html)

with open('social.html', 'w', encoding='utf-8') as f:
    f.write(social_html)
print("social.html created successfully.")

print("Updating index.html link references...")
with open('index.html', 'r', encoding='utf-8') as f:
    idx_content = f.read()

# Update dropdown menu for social
idx_content = idx_content.replace('<a href="index.html#div-social"><span class="dd-icon">◈</span> Social Sciences</a>',
                                  '<a href="social.html"><span class="dd-icon">◈</span> Social Sciences, Humanities &amp; Communication</a>')

# Update homepage card link for social
start_idx = idx_content.find('<div class="division-card" id="div-social"')
if start_idx != -1:
    link_idx = idx_content.find('href="#contact"', start_idx)
    if link_idx != -1:
        idx_content = idx_content[:link_idx] + 'href="social.html" class="div-link">Explore Division →</a>' + idx_content[idx_content.find('</a>', link_idx)+4:]
...
if nav_match:
    ...
    files = [
        ...
        'quality.html', 'academy.html', 'young.html', 'awards.html', 'research.html', 'accounting.html', 'business.html', 'finance.html', 'hr.html', 'economics.html', 'law.html', 'it.html', 'engineering.html', 'social.html'
    ]
    for fn in files:
    ...
    idx_content = re.sub(r'style\.css\?v=\d+', 'style.css?v=36', idx_content)
    with open('index.html', 'w', encoding='utf-8') as f:
        f.write(idx_content)
